...
def get_args():
    ...
    parser.add_argument("--batch-size", type=int, default=256, help="number of batch size, (default, 256)")
...
def main():
    ...
    # model_name = "MobileNet_2_"+str(args.dataset_mode)+"_epochs"+str(args.epochs)

    # from model_acnet_expansion import MobileNetV3_Acnet
    ...
    # model_name = "model_acnet_expansion_self_global"+ str(args.dataset_mode) +"_epochs"+str(args.epochs)
    # model_name = "model_acnet_expansion_self_local"+ str(args.dataset_mode) +"_epochs"+str(args.epochs)
    # model_name = "model_acnet_expansion_local_global"+ str(args.dataset_mode) +"_epochs"+str(args.epochs)


    # from model_acnet_projection import MobileNetV3_Acnet
    # model = MobileNetV3_Acnet(model_mode=args.model_mode, num_classes=num_classes, multiplier=args.multiplier, dropout_rate=args.dropout).to(device)
    # model_name = "model_acnet_projection_self_global"+ str(args.dataset_mode) +"_epochs"+str(args.epochs)
    # model_name = "model_acnet_projection_self_local"+ str(args.dataset_mode) +"_epochs"+str(args.epochs)

    from model_acnet_all import MobileNetV3_Acnet

    model = MobileNetV3_Acnet(model_mode=args.model_mode, num_classes=num_classes, multiplier=args.multiplier, dropout_rate=args.dropout).to(device)
    model_name = "model_acnet_dw"+ str(args.dataset_mode) +"_epochs"+str(args.epochs)
